...
$TBS->LoadTemplate(dirname(__FILE__).'/office/'.$prefix.'a23fad.docx', OPENTBS_ALREADY_UTF8);
$TBS->MergeBlock('t','array','t');
$TBS->Show(OPENTBS_DOWNLOAD, 'a23fad_'.$d['mese'].'_'.$t[0]['corsobreve'].'_'.$t[0]['username'].'.docx');
?>